...
export class AccountChangeCredentialsComponent {
  ...
  changePassword() {
    this.dataService
      .mutate<ChangePasswordMutation, ChangePasswordMutationVariables>(CHANGE_PASSWORD, {
  ...
  changeEmailAddress() {
    this.dataService
      .mutate<ChangeEmailAddressMutation, ChangeEmailAddressMutationVariables>(CHANGE_EMAIL_ADDRESS, {
