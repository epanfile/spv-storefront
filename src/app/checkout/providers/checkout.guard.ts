...
export class CheckoutGuard {
  ...
  canActivate(route: ActivatedRouteSnapshot): Observable<boolean> {
    const orderState$ = this.dataService
      .query<GetOrderForCheckoutQuery>(GET_ORDER_FOR_CHECKOUT, undefined, 'cache-first')
      .pipe(map((data) => (data.activeOrder ? data.activeOrder.state : 'AddingItems')));
